...
A food web (or food cycle) is a natural interconnection of food chains and a graphical representation (usually an image) of what-eats-what in an ecological community. Another name for food web is consumer-resource system.
  ...
  <table border="0" width="50%">
                                    ...
                                    <tr>
                                        <td height="5" style="text-align:center;font-weight:bold;background-color:orange;color:white;width:500px;font-family:verdana;font-size:16px;">
                                    ...
                                    <tr>
                                        <td height="40px" style="font-size:30px;" align="center">
                                      ...
                                      <tr>
                                        <td height="35px" style="font-size:15px;" align="center">
                                       <a href="index.jsp">  Click to Login  </a>
                                        </td>
                                    </tr>
                                         <tr>
                                        <td height="25">
