            ...
            <div id="homecontent">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td align="center"><a href="ShoppingCart2.jsp?PorductID=<%=proid%>">Remove</a></td>
                    </tr>
                    <%
                                    }
                                } catch (Exception e) {
                    ...
                    <tr>
                        <td align="right">
                            <a href="UserProductList2.jsp?type=Cloths" id="link">Continue Shopping</a>
                            <a href="Payment2.jsp?TotalPrice=<%=total%>" style="background-color: skyblue;font-weight: bold;">Card Payment</a>
