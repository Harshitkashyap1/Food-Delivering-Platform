     ...
     <div class="wrapper col3">
            <div id="homecontent">
                <div class="fl_left">
                    <div class="column2">
                        <ul>
                            <li>
                                <h2>RESTRO KART</h2>
                                <div class="imgholder"><img src="img/d.jpg" height="200" width="200" alt="" /></div>
                                <p>
                ...
                We're always looking for great folks to join us on our mission. If you want to be a part of our story, we'd love to chat. Explore our careers section to see if there's a role that excites you. If there isn't one and we like each other, we'll create one for you.
                            ...
                            <li class="last">
                                <h2>RESTRO KART</h2>
                                <div class="imgholder"><img src="img/l.jpg" height="200" width="200" alt="" /></div>
                                <p>
            Our team gathers information from every restaurant on a regular basis to ensure our data is fresh. Our vast community of food lovers share their reviews and photos, so you have all that you need to make an informed choice.
                ...
                <div class="fl_right">
                    <h2>Latest News From The  RESTRO KART</h2>
                    <marquee direction="up"><ul>
                            <li>
                                <div class="imgholder"><a href="#"><img src="img/brk.jpg" alt="" /></a></div>
                                <p><strong><a href="#">RESTRO KART</a></strong></p>
                                <p>


                     User friendly ordering. </li>
                            <li>
                                <div class="imgholder"><a href="#"><img src="img/be.png" alt="" /></a></div>
                                <p><strong><a href="#"> RESTRO KART</a></strong></p>
                                <p>
                      A central database holds the key to system.   </li>
                            <li>
                                <div class="imgholder"><a href="#"><img src="img/f.jpg" alt="" /></a></div>
                                <p><strong><a href="#"> RESTRO KART</a></strong></p>
                                <p>
                       In summary we can say that main objective of the project is to make the work easy and smooth.  </p>
                            </li>
